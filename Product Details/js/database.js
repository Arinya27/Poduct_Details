...
function populateDB(tx) {
	...
	tx.executeSql('INSERT INTO EMPLOYEE (id, pName,pDesc,pPrice,pImage) VALUES (0, "iBall Rocky Clarity Headsets","1 Year Manufacturer warranty","Rs. 399","prd_img1.png")');
	
	tx.executeSql('INSERT INTO EMPLOYEE (id, pName,pDesc,pPrice,pImage) VALUES (1, "Sandisk USB Pendrive","32GB Slider","Rs. 1949","prd_img2.png")');
	
	tx.executeSql('INSERT INTO EMPLOYEE (id, pName,pDesc,pPrice,pImage) VALUES (2, "Enter USB 2.0 Speaker","6 Months Vendor Warranty","Rs. 499","prd_img3.png")');
	
	tx.executeSql('INSERT INTO EMPLOYEE (id, pName,pDesc,pPrice,pImage) VALUES (3, "Dp Branded 31 LED","Flexible Rechargable Table Lamp","Rs. 299","prd_img4.png")');
